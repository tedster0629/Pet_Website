    ...
    <div id="content" class="container-fluid">
        ...
        <div>
            ...
            <div class="container mb-3">
                <form class="row g-3" action="{{ route('dashboard.products.update',['product'=>$product->id]) }}" enctype="multipart/form-data" method="POST">
                    <!-- Add a pet Content -->
                    @csrf
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="discountable" class="form-select" name="discountable">
                            <option value="No" {{ $product->discountable == 'No' ? 'selected' : '' }}>No</option>
                            <option value="Yes" {{ $product->discountable == 'Yes' ? 'selected' : '' }}>Yes</option>
                        </select>
                        @error('discountable')
                            <span class="text-danger fst-italic">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="downloadable" class="form-select" name="downloadable">
                            <option value="No" {{ $product->downloadable == 'No' ? 'selected' : '' }}>No</option>
                            <option value="Yes" {{ $product->downloadable == 'Yes' ? 'selected' : '' }}>Yes</option>
                        </select>
                        @error('downloadable')
                            <span class="text-danger fst-italic">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="promoted" class="form-select" name="promoted">
                            <option value="No" {{ $product->promoted == 'No' ? 'selected' : '' }}>No</option>
                            <option value="Yes" {{ $product->promoted == 'Yes' ? 'selected' : '' }}>Yes</option>
                        </select>
                        @error('promoted')
                            <span class="text-danger fst-italic">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="sale" class="form-select" name="sale">
                            <option value="No" {{ $product->sale == 'No' ? 'selected' : '' }}>No</option>
                            <option value="Yes" {{ $product->sale == 'Yes' ? 'selected' : '' }}>Yes</option>
                        </select>
                        @error('sale')
                            <span class="text-danger fst-italic">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" placeholder="Leave a description here" name="description" id="description"
                            maxlength="330" col="10" rows="4">{{ $product->description }}</textarea>
                        @error('description')
                            <span class="text-danger fst-italic">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary" id="add-pet">Update Product</button>
                    </div>
                </form>
            </div>
        </div>
