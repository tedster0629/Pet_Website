...
<div class="container mt-5 mb-5 d-flex">
  <div class="card rounded" style="width: 100%">
    <div class=" d-flex justify-content-center">
        <img src="../images/featured_1.jpg" class="rounded" width="" height="400" />
        <div class="area2 px-3">
          <h4 class=" name mt-3 text-center">Duke</h4>
          <div class="hr"></div>
          <div class="d-flex">
          ...
          <div class="hr"></div>
          <div class="d-flex">
            <p style="margin-right: 1.5rem;"><span class="back">City: </span> Toronto</p>
